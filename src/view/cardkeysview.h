...
private:
    ...
    QToolButton *createActionsButton(const SmartCard::Card *card, const SmartCard::KeyPairInfo &keyInfo, const GpgME::Subkey &subkey);
...
private:
    ...
    QHash<std::string, QAction *> mActions;
};
} // namespace Kleo
